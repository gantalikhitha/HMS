...
public class HospitalserviceImp implements HospitalService {
	...
	public Appointment save(Appointment appo) {
	  ...
	  @Override public UserEntity getByHname(String hname) {
	  
	  return hospitalRepository.findByHname(hname); }
	 
	@Override
	public BillingDetails save(BillingDetails billingDetails) {
		UserEntity ij= hospitalRepository.findById(1).get();
		billingDetails.setHospital(ij);
		billingDetails.getHospital().setHid(1);
		
		return hospitalRepository.save(billingDetails);
	}
